...
//    app.post('/miix/videos/user_content_files', routes.authorizationHandler.checkAuth, routes.uploadUserContentFile_cb ); //v1.2
    ...
    /**
     * Upload a base64 image UGC of a specific project ID from server. The uploaded image data will be save as a PNG file.<br>
     * When server generates doohPreview and longPhoto, here's a function to save these UGCs.<br>
     * <br>
     * The base64 image is often generated by calling toDataURL() of HTML5 Canvas. 
     * It normally needs to do the following process before sending to this API:<br>
     * yourCanvas.toDataURL('image/png').replace('image/octet-stream');
     ...
     * <h5>Response body</h5>
     * 
     * @name PUT /miix/base64_image_ugcs_from_web/:ugcProjectId
     * @memberof miix
     */
    
    app.put('/miix/web/base64_image_ugcs/:ugcProjectId', routes.authorizationHandler.checkAuth, routes.miixHandler.putBase64ImageUgcsFromWeb_cb);
    
    /**
     * Upload user's ugcInfo from website when user press "SEND" to server.<br>
     * The ugcInfo will tell server which ugcs need to upload to S3.<br>
     * <br>
     * 
     * <h5>Path parameters</h5>
     * <ul>
     ...
     * <h5>Response body</h5>
     * 
     * @name PUT /miix/web/ugcs_info/:ugcProjectId
     * @memberof miix
     */
    app.put('/miix/web/ugcs_info/:ugcProjectId', routes.authorizationHandler.checkAuth, routes.miixHandler.putImageUgcsInfo_cb);
    /**
