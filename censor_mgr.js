...
censorMgr.getUGCListLite = function(condition, cb){
    ...
    FMDB.listOfdocModels( UGCs,{'createdOn' : {$gte: condition.start, $lt: condition.end}},'_id genre contentGenre projectId fileExtension no ownerId', {sort :{'doohPlayedTimes':1,'rating':1,'createdOn':1}}, function(err, result){
        if(err) {
